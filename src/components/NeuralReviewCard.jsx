  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <svg className="absolute -top-0.5 lg:-top-2 -left-0.5 w-2 h-2 lg:w-4 lg:h-4 text-slate-100" fill="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-slate-600 text-[8px] lg:text-[12px] leading-snug italic pl-2.5 lg:pl-4">
