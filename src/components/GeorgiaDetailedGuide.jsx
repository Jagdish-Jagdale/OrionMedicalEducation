        ...
        <div className="relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative p-2 sm:p-4 rounded-2xl sm:rounded-3xl overflow-hidden group shadow-2xl transition-all duration-500 hover:shadow-[0_0_50px_rgba(220,38,38,0.4)]">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-red-600 via-red-700 to-red-800 opacity-100 group-hover:scale-110 transition-transform duration-700" />
              ...
              <div className="relative z-10 bg-white/20 backdrop-blur-2xl rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-white/30 shadow-2xl overflow-hidden group-hover:scale-[1.02] group-hover:-translate-y-2 group-hover:border-white/60 transition-all duration-500">
                ...
                <h3 className="text-xl font-bold mb-4 text-white relative z-10">Global Recognition</h3>
                ...
                <div className="flex gap-4 relative z-10">
                  ...
                  <div className="px-3 py-1 bg-white/20 rounded-full text-[10px] font-bold border border-white/30 text-white backdrop-blur-md">WDOMS</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="w-full">
                <div className="bg-white rounded-lg sm:rounded-xl p-6 sm:p-10 shadow-lg border border-slate-50 flex flex-col h-full relative overflow-hidden group hover:border-red-200 transition-all">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <a
                      href={`https://wa.me/${waNumber}?text=Hi, I am interested in ${uni.name}, Georgia.`}
                      target="_blank"
