      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative p-2 sm:p-4 rounded-2xl sm:rounded-3xl overflow-hidden group shadow-2xl transition-all duration-500 hover:shadow-[0_0_50px_rgba(56,189,248,0.4)]">
              {/* Background colored container */}
              <div className="absolute inset-0 bg-gradient-to-br from-sky-400 via-blue-500 to-blue-700 opacity-100 group-hover:scale-110 transition-transform duration-700" />
              ...
              <div className="w-full">
                <div className="bg-white rounded-lg sm:rounded-xl p-6 sm:p-10 shadow-lg border border-slate-50 flex flex-col h-full relative overflow-hidden group hover:border-blue-200 transition-all">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <a
                      href={`https://wa.me/${waNumber}?text=Hi, I am interested in ${uni.name}, Kazakhstan.`}
                      target="_blank"
