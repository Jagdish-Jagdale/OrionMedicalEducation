      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            ...
            />
            <div>
              <h2 className="text-3xl font-bold text-navy">MBBS in Uzbekistan</h2>
              <p className="text-cyan-600 font-semibold tracking-wide uppercase text-xs mt-1">Budget-Friendly, Globally Recognized</p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-navy to-cyan-900 rounded-lg sm:rounded-xl p-6 sm:p-8 text-white shadow-2xl relative overflow-hidden">
              ...
              <p className="text-cyan-100 text-sm leading-relaxed mb-6 relative z-10">
            ...
            >
              ...
              <div className="w-full">
                <div className="bg-white rounded-lg sm:rounded-xl p-6 sm:p-10 shadow-lg border border-slate-50 flex flex-col h-full relative overflow-hidden group hover:border-cyan-200 transition-all">
                  ...
                  <h3 className="text-2xl font-bold text-navy mb-4 group-hover:text-cyan-600 transition-colors uppercase tracking-tight">{uni.name}</h3>
