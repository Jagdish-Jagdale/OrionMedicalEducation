...
import { getContactPageData, getHomeContent, saveContactSubmission } from '../firebase/firestore';
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pb-24">
            ...
            >
               ...
               <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-4 bg-white text-green-600 font-bold px-12 py-5 rounded-full hover:shadow-2xl transition-all text-lg shadow-xl"
               >
            ...
            >
               <h2 className="text-2xl font-bold text-navy mb-2 tracking-tight">So future doctors! What are you waiting for?</h2>
