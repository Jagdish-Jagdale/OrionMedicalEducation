      ...
      <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/admin" element={<ProtectedRoute><MinimalLayout><AdminHome /></MinimalLayout></ProtectedRoute>} />
            <Route path="/admin/dashboard" element={<ProtectedRoute><MinimalLayout><AdminHome /></MinimalLayout></ProtectedRoute>} />
